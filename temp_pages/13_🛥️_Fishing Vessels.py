...
st.markdown("<h1 style='text-align: center; '>🛥️FISHING VESSELS</h1>",
            unsafe_allow_html=True)
st.markdown("<h3 style='text-align: center; font-family: Segoe UI;'>Fishing Vessels Object Detection using YOLOv8</h3>", unsafe_allow_html=True)
...
try:
    ...
    fishing_vessels_detector = YOLOService("weights/ship.pt") 
    ...
    if uploaded_file is not None:
        ...
        detect_image = fishing_vessels_detector.detect(uploaded_file)
