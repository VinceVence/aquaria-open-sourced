...
# Set page title
st.set_page_config(page_title="🎣Marine Debris")

# FRONTEND UI

st.markdown("<h1 style='text-align: center; '>🎣MARINE DEBRIS</h1>",
            unsafe_allow_html=True)
st.markdown("<h3 style='text-align: center; font-family: Segoe UI;'>Marine Debris Object Detection using YOLOv8</h3>", unsafe_allow_html=True)
...
try:
    ...
    marine_debris_detector = YOLOService("weights/marine_debris.pt")
    ...
    if uploaded_file is not None:
        ...
        detect_image = marine_debris_detector.detect(uploaded_file)
