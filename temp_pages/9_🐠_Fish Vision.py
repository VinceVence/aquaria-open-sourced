...
# Set page title
st.set_page_config(page_title="🐠Fish Vision")

#################### FRONTEND ########################

st.markdown("<h1 style='text-align: center; '>🐠FISH VISION</h1>",
...
try:
    ...
    fish_detector = YOLOService("weights/fish_vision.pt")
    ...
    if uploaded_file is not None:
        ...
        detect_image = fish_detector.detect(uploaded_file)
